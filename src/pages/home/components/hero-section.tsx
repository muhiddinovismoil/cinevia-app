                        ...
                        <div className="relative w-full h-full">
                            ...
                            <div className="absolute inset-0 flex flex-col justify-end px-6 md:px-24 pb-20 text-white">
                                ...
                                <div className="flex justify-end w-full">
                                    <button className="group relative flex items-center gap-2 px-5 py-2.5 rounded-lg font-medium text-base md:text-lg text-white bg-gray-800/80 backdrop-blur-sm shadow-md hover:bg-gray-700 hover:shadow-lg hover:scale-105 transition-all duration-300 cursor-pointer">
                                        {slide.buttonText}
